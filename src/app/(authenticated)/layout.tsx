          ...
          <div style={{ width: '260px', display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <nav style={{ padding: '0 0.5rem', display: 'flex', flexDirection: 'column', gap: '0.25rem', flex: 1 }}>
              ...
              <Link href="/trainee-contents" className={getLinkClass('/trainee-contents')}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"></path><path d="M6 12v5c3 3 9 3 12 0v-5"></path></svg>
                전체 콘텐츠(수습 단원용)
              </Link>
